...
var oo = {
    ...
    job_area: ea,
    job_descriptor: aa,
    job_title_pattern: oa,
    job_type: ra,
    last_name: na,
    last_name_pattern: ia,
    middle_name: ta,
    name: la,
    prefix: sa,
    sex: da,
    suffix: ua,
    western_zodiac_sign: ca
}, ma = oo;
var ha = [
    "!##-!##-####",
    "(!##) !##-####",
...
"[project]/node_modules/@faker-js/faker/dist/chunk-4ULBYILW.js [app-rsc] (ecmascript)": (({ r: __turbopack_require__, f: __turbopack_module_context__, i: __turbopack_import__, s: __turbopack_esm__, v: __turbopack_export_value__, n: __turbopack_export_namespace__, c: __turbopack_cache__, M: __turbopack_modules__, l: __turbopack_load__, j: __turbopack_dynamic__, P: __turbopack_resolve_absolute_path__, U: __turbopack_relative_url__, R: __turbopack_resolve_module_id_path__, g: global, __dirname, x: __turbopack_external_require__, y: __turbopack_external_import__ }) => (() => {
"use strict";
...
function ge(i) {
    ...
    do {
        for (let t of Object.getOwnPropertyNames(e))typeof i[t] == "function" && t !== "constructor" && (i[t] = i[t].bind(i));
...
var ye = ((r)=>(r.Narrowbody = "narrowbody", r.Regional = "regional", r.Widebody = "widebody", r))(ye || {}), nt = [
    "0",
    "1",
    "2",
    "3",
    ...
    recordLocator(e = {}) {
        let { allowNumerics: t = !1, allowVisuallySimilarCharacters: r = !1 } = e, n = [];
        return t || n.push(...nt), r || n.push(...at), this.faker.string.alphanumeric({
            length: 6,
            casing: "upper",
            exclude: n
        });
    ...
    seat(e = {}) {
        let { aircraftType: t = "narrowbody" } = e, r = it[t], n = ot[t], a = this.faker.number.int({
            min: 1,
            max: r
    ...
    aircraftType() {
        return this.faker.helpers.enumValue(ye);
    }
    flightNumber(e = {}) {
        let { length: t = {
            min: 1,
...
var ke = ((a)=>(a.SRGB = "sRGB", a.DisplayP3 = "display-p3", a.REC2020 = "rec2020", a.A98RGB = "a98-rgb", a.ProphotoRGB = "prophoto-rgb", a))(ke || {}), xe = ((c)=>(c.RGB = "rgb", c.RGBA = "rgba", c.HSL = "hsl", c.HSLA = "hsla", c.HWB = "hwb", c.CMYK = "cmyk", c.LAB = "lab", c.LCH = "lch", c.COLOR = "color", c))(xe || {});
function st(i, e) {
    let { prefix: t, casing: r } = e;
    switch(r){
        case "upper":
            {
                i = i.toUpperCase();
...
function ct(i, e = "rgb", t = "sRGB") {
    let r = (n)=>Math.round(n * 100);
    switch(e){
        case "rgba":
            return `rgba(${i[0]}, ${i[1]}, ${i[2]}, ${i[3]})`;
        case "color":
            return `color(${t} ${i[0]} ${i[1]} ${i[2]})`;
        case "cmyk":
            return `cmyk(${r(i[0])}%, ${r(i[1])}%, ${r(i[2])}%, ${r(i[3])}%)`;
        case "hsl":
            return `hsl(${i[0]}deg ${r(i[1])}% ${r(i[2])}%)`;
        case "hsla":
            return `hsl(${i[0]}deg ${r(i[1])}% ${r(i[2])}% / ${r(i[3])})`;
        case "hwb":
            return `hwb(${i[0]} ${r(i[1])}% ${r(i[2])}%)`;
        case "lab":
            return `lab(${r(i[0])}% ${i[1]} ${i[2]})`;
        case "lch":
            return `lch(${r(i[0])}% ${i[1]} ${i[2]})`;
        case "rgb":
            return `rgb(${i[0]}, ${i[1]}, ${i[2]})`;
    }
}
function C(i, e, t = "rgb", r = "sRGB") {
    switch(e){
        case "css":
            return ct(i, t, r);
        case "binary":
...
var I = class extends p {
    ...
    cssSupportedFunction() {
        return this.faker.helpers.enumValue(xe);
    }
    cssSupportedSpace() {
        return this.faker.helpers.enumValue(ke);
    }
    rgb(e = {}) {
        let { format: t = "hex", includeAlpha: r = !1, prefix: n = "#", casing: a = "lower" } = e, o, s = "rgb";
        return t === "hex" ? (o = this.faker.string.hexadecimal({
            length: r ? 8 : 6,
            prefix: ""
        }), o = st(o, {
            prefix: n,
    ...
    cmyk(e = {}) {
        let { format: t = "decimal" } = e, r = Array.from({
            length: 4
    ...
    hsl(e = {}) {
        let { format: t = "decimal", includeAlpha: r = !1 } = e, n = [
            this.faker.number.int(360)
        ];
        for(let a = 0; a < (e?.includeAlpha ? 3 : 2); a++)n.push(this.faker.number.float({
            multipleOf: .01
        }));
        return C(n, t, r ? "hsla" : "hsl");
    }
    hwb(e = {}) {
        let { format: t = "decimal" } = e, r = [
            this.faker.number.int(360)
        ];
    ...
    colorByCSSColorSpace(e = {}) {
        let { format: t = "decimal", space: r = "sRGB" } = e, n = Array.from({
            length: 3
        }, ()=>this.faker.number.float({
                multipleOf: 1e-4
            }));
        return C(n, t, "color", r);
    }
};
var he = ((n)=>(n.Legacy = "legacy", n.Segwit = "segwit", n.Bech32 = "bech32", n.Taproot = "taproot", n))(he || {}), Ee = ((t)=>(t.Mainnet = "mainnet", t.Testnet = "testnet", t))(Ee || {}), we = {
    legacy: {
        prefix: {
            mainnet: "1",
            testnet: "m"
...
var Se = ((t)=>(t.Female = "female", t.Male = "male", t))(Se || {});
function N(i, e, t) {
    let { generic: r, female: n, male: a } = t;
    switch(e){
        case "female":
            return n ?? r;
        case "male":
            return a ?? r;
        default:
            return r ?? i.helpers.arrayElement([
                n,
                a
            ]) ?? [];
    }
...
var _ = class extends p {
    firstName(e) {
        return this.faker.helpers.arrayElement(N(this.faker, e, this.faker.definitions.person.first_name));
    }
    lastName(e) {
        if (this.faker.rawDefinitions.person?.last_name_pattern != null) {
            let t = this.faker.helpers.weightedArrayElement(N(this.faker, e, this.faker.rawDefinitions.person.last_name_pattern));
            return this.faker.helpers.fake(t);
        }
        return this.faker.helpers.arrayElement(N(this.faker, e, this.faker.definitions.person.last_name));
    }
    middleName(e) {
        return this.faker.helpers.arrayElement(N(this.faker, e, this.faker.definitions.person.middle_name));
    }
    fullName(e = {}) {
        let { sex: t = this.faker.helpers.arrayElement([
            "female",
            "male"
        ]), firstName: r = this.firstName(t), lastName: n = this.lastName(t) } = e, a = this.faker.helpers.weightedArrayElement(this.faker.definitions.person.name);
        return this.faker.helpers.mustache(a, {
            "person.prefix": ()=>this.prefix(t),
            "person.firstName": ()=>r,
            "person.middleName": ()=>this.middleName(t),
            "person.lastName": ()=>n,
    ...
    sexType() {
        return this.faker.helpers.enumValue(Se);
    }
    bio() {
    ...
    prefix(e) {
        return this.faker.helpers.arrayElement(N(this.faker, e, this.faker.definitions.person.prefix));
    }
    suffix() {
...
var D = class {
    ...
    subtraction32(e, t) {
        return e < t ? this.unsigned32(4294967296 - (t - e) & 4294967295) : e - t;
    }
    addition32(e, t) {
        return this.unsigned32(e + t & 4294967295);
    }
    multiplication32(e, t) {
        let r = 0;
        for(let n = 0; n < 32; ++n)e >>> n & 1 && (r = this.addition32(r, this.unsigned32(t << n)));
        return r;
    }
    initGenrand(e) {
    ...
    initByArray(e, t) {
        ...
        let r = 1, n = 0, a = this.N > t ? this.N : t;
        for(; a; a--)this.mt[r] = this.addition32(this.addition32(this.unsigned32(this.mt[r] ^ this.multiplication32(this.unsigned32(this.mt[r - 1] ^ this.mt[r - 1] >>> 30), 1664525)), e[n]), n), this.mt[r] = this.unsigned32(this.mt[r] & 4294967295), r++, n++, r >= this.N && (this.mt[0] = this.mt[this.N - 1], r = 1), n >= t && (n = 0);
        for(a = this.N - 1; a; a--)this.mt[r] = this.subtraction32(this.unsigned32(this.mt[r] ^ this.multiplication32(this.unsigned32(this.mt[r - 1] ^ this.mt[r - 1] >>> 30), 1566083941)), r), this.mt[r] = this.unsigned32(this.mt[r] & 4294967295), r++, r >= this.N && (this.mt[0] = this.mt[this.N - 1], r = 1);
    ...
    genrandInt32() {
        ...
        if (this.mti >= this.N) {
            let t;
            for(this.mti === this.N + 1 && this.initGenrand(5489), t = 0; t < this.N - this.M; t++)e = this.unsigned32(this.mt[t] & this.UPPER_MASK | this.mt[t + 1] & this.LOWER_MASK), this.mt[t] = this.unsigned32(this.mt[t + this.M] ^ e >>> 1 ^ this.mag01[e & 1]);
            for(; t < this.N - 1; t++)e = this.unsigned32(this.mt[t] & this.UPPER_MASK | this.mt[t + 1] & this.LOWER_MASK), this.mt[t] = this.unsigned32(this.mt[t + (this.M - this.N)] ^ e >>> 1 ^ this.mag01[e & 1]);
    ...
    genrandRes53() {
        let e = this.genrandInt32() >>> 5, t = this.genrandInt32() >>> 6;
...
function er() {
    ...
    return i.initGenrand(Math.ceil(Math.random() * Number.MAX_SAFE_INTEGER)), {
        next () {
            return i.genrandReal2();
        },
        seed (e) {
            typeof e == "number" ? i.initGenrand(e) : Array.isArray(e) && i.initByArray(e, e.length);
        }
    };
}
function Te() {
...
var G = class extends x {
    boolean(e = {}) {
        ...
        let { probability: t = .5 } = e;
        return t <= 0 ? !1 : t >= 1 ? !0 : this.faker.number.float() < t;
    }
};
var F = ()=>{
...
function Me(i) {
    ...
    return new Proxy(i, {
        ...
        get (t, r) {
            return typeof r == "symbol" || r === "nodeType" ? t[r] : r in e ? e[r] : e[r] = lt(r, t[r]);
        },
        set: F,
        deleteProperty: F
    });
...
function lt(i, e = {}) {
    return new Proxy(e, {
        ...
        get (t, r) {
            let n = t[r];
            return typeof r == "symbol" || r === "nodeType" || O(n, i, r.toString()), n;
        },
        set: F,
        deleteProperty: F
    });
}
function M(i, e = "refDate") {
    let t = new Date(i);
    if (Number.isNaN(t.valueOf())) throw new m(`Invalid ${e} date: ${i.toString()}`);
    return t;
}
var R = class extends x {
    anytime(e = {}) {
        let { refDate: t = this.faker.defaultRefDate() } = e, r = M(t).getTime();
        return this.between({
    ...
    past(e = {}) {
        let { years: t = 1, refDate: r = this.faker.defaultRefDate() } = e;
        if (t <= 0) throw new m("Years must be greater than 0.");
        let n = M(r).getTime();
        return this.between({
            from: n - t * 365 * 24 * 3600 * 1e3,
            to: n - 1e3
        });
    }
    future(e = {}) {
        ...
        return this.between({
            from: n + 1e3,
            to: n + t * 365 * 24 * 3600 * 1e3
        });
    }
    between(e) {
        if (e == null || e.from == null || e.to == null) throw new m("Must pass an options object with `from` and `to` values.");
        let { from: t, to: r } = e, n = M(t, "from").getTime(), a = M(r, "to").getTime();
        if (n > a) throw new m("`from` date must be before `to` date.");
    ...
    betweens(e) {
        if (e == null || e.from == null || e.to == null) throw new m("Must pass an options object with `from` and `to` values.");
        let { from: t, to: r, count: n = 3 } = e;
        return this.faker.helpers.multiple(()=>this.between({
                from: t,
                to: r
            }), {
            count: n
        }).sort((a, o)=>a.getTime() - o.getTime());
    }
    recent(e = {}) {
        let { days: t = 1, refDate: r = this.faker.defaultRefDate() } = e;
        if (t <= 0) throw new m("Days must be greater than 0.");
        let n = M(r).getTime();
        return this.between({
            from: n - t * 24 * 3600 * 1e3,
            to: n - 1e3
        });
    }
    soon(e = {}) {
    ...
    birthdate(e = {}) {
        let { mode: t = "age", min: r = 18, max: n = 80, refDate: a = this.faker.defaultRefDate(), mode: o, min: s, max: l } = e;
        if ([
            s,
            l,
            o
        ].filter((f)=>f != null).length % 3 !== 0) throw new m("The 'min', 'max', and 'mode' options must be set together.");
        let u = M(a), h = u.getUTCFullYear();
        switch(t){
            case "age":
                {
                    let g = new Date(u).setUTCFullYear(h - n - 1) + 864e5, b = new Date(u).setUTCFullYear(h - r);
                    if (g > b) throw new m(`Max age ${n} should be greater than or equal to min age ${r}.`);
                    return this.between({
                        from: g,
                        to: b
                    });
            ...
            case "year":
                {
                    let f = new Date(Date.UTC(0, 0, 2)).setUTCFullYear(r), g = new Date(Date.UTC(0, 11, 30)).setUTCFullYear(n);
                    if (f > g) throw new m(`Max year ${n} should be greater than or equal to min year ${r}.`);
                    return this.between({
                        from: f,
                        to: g
                    });
    ...
    month(t = {}) {
        let { abbreviated: r = !1, context: n = !1 } = t, a = this.faker.definitions.date.month, o;
        r ? o = n && a.abbr_context != null ? "abbr_context" : "abbr" : o = n && a.wide_context != null ? "wide_context" : "wide";
        let s = a[o];
        return O(s, "date.month", o), this.faker.helpers.arrayElement(s);
    }
    weekday(t = {}) {
        let { abbreviated: r = !1, context: n = !1 } = t, a = this.faker.definitions.date.weekday, o;
        r ? o = n && a.abbr_context != null ? "abbr_context" : "abbr" : o = n && a.wide_context != null ? "wide_context" : "wide";
        let s = a[o];
        return O(s, "date.weekday", o), this.faker.helpers.arrayElement(s);
    }
    timeZone() {
...
function Ce(i, e, t = [
    ...
    if (t.length === 0) throw new m("Eval entrypoints cannot be empty.");
    let r = t, n = i;
    do {
        let o;
        n.startsWith("(") ? [o, r] = ut(n, r, i) : [o, r] = pt(n, r), n = n.substring(o), r = r.filter((s)=>s != null).map((s)=>Array.isArray(s) ? e.helpers.arrayElement(s) : s);
    }while (n.length > 0 && r.length > 0)
    if (r.length === 0) throw new m(`Cannot resolve expression '${i}'`);
    let a = r[0];
    return typeof a == "function" ? a() : a;
}
function ut(i, e, t) {
    let [r, n] = ht(i), a = i[r + 1];
    switch(a){
        case ".":
        case "(":
        case void 0:
            break;
        default:
            throw new m(`Expected dot ('.'), open parenthesis ('('), or nothing after function call but got '${a}'`);
    }
    return [
        r + (a === "." ? 2 : 1),
...
function pt(i, e) {
    let t = mt.exec(i), r = (t?.[0] ?? "") === ".", n = t?.index ?? i.length, a = i.substring(0, n);
    if (a.length === 0) throw new m(`Expression parts cannot be empty in '${i}'`);
    let o = i[n + 1];
    if (r && (o == null || o === "." || o === "(")) throw new m(`Found dot without property name in '${i}'`);
    return [
        n + (r ? 1 : 0),
        e.map((s)=>ft(s, a))
    ];
...
function bt(i) {
    ...
    for(let r = i.length - 1; r >= 0; r--){
        let n = Number.parseInt(i[r]);
        t && (n *= 2, n > 9 && (n = n % 10 + 1)), e += n, t = !t;
    }
    return e % 10;
}
function De(i, e, t, r) {
    ...
    if (e) switch(e){
        case "?":
            {
                n = i.datatype.boolean() ? 0 : 1;
                break;
            }
        case "*":
            {
                let a = 1;
                for(; i.datatype.boolean();)a *= 2;
                n = i.number.int({
                    min: 0,
                    max: a
                });
    ...
    else t != null && r != null ? n = i.number.int({
        min: Number.parseInt(t),
        max: Number.parseInt(r)
    }) : t != null && r == null && (n = Number.parseInt(t));
    return n;
}
function dt(i, e = "") {
    let t = /(.)\{(\d+),(\d+)\}/, r = /(.)\{(\d+)\}/, n = /\[(\d+)-(\d+)\]/, a, o, s, l, c = t.exec(e);
    for(; c != null;)a = Number.parseInt(c[2]), o = Number.parseInt(c[3]), a > o && (s = o, o = a, a = s), l = i.number.int({
        min: a,
        max: o
    }), e = e.slice(0, c.index) + c[1].repeat(l) + e.slice(c.index + c[0].length), c = t.exec(e);
    for(c = r.exec(e); c != null;)l = Number.parseInt(c[2]), e = e.slice(0, c.index) + c[1].repeat(l) + e.slice(c.index + c[0].length), c = r.exec(e);
    for(c = n.exec(e); c != null;)a = Number.parseInt(c[1]), o = Number.parseInt(c[2]), a > o && (s = o, o = a, a = s), e = e.slice(0, c.index) + i.number.int({
        min: a,
        max: o
    }).toString() + e.slice(c.index + c[0].length), c = n.exec(e);
    return e;
}
function pe(i, e = "", t = "#") {
    let r = "";
    for(let n = 0; n < e.length; n++)e.charAt(n) === t ? r += i.number.int(9) : e.charAt(n) === "!" ? r += i.number.int({
        min: 2,
        max: 9
    }) : r += e.charAt(n);
    return r;
...
var L = class extends x {
    ...
    replaceSymbols(e = "") {
        ...
        for(let n = 0; n < e.length; n++)e.charAt(n) === "#" ? r += this.faker.number.int(9) : e.charAt(n) === "?" ? r += this.arrayElement(t) : e.charAt(n) === "*" ? r += this.faker.datatype.boolean() ? this.arrayElement(t) : this.faker.number.int(9) : r += e.charAt(n);
        return r;
    }
    replaceCreditCardSymbols(e = "6453-####-####-####-###L", t = "#") {
        e = dt(this.faker, e), e = pe(this.faker, e, t);
        let r = Ne(e);
        return e.replace("L", String(r));
    }
    fromRegExp(e) {
        let t = !1;
        e instanceof RegExp && (t = e.flags.includes("i"), e = e.toString(), e = /\/(.+?)\//.exec(e)?.[1] ?? "");
        let r, n, a, o = /([.A-Za-z0-9])(?:\{(\d+)(?:,(\d+)|)\}|(\?|\*|\+))(?![^[]*]|[^{]*})/, s = o.exec(e);
        for(; s != null;){
            let f = s[2], g = s[3], b = s[4];
            a = De(this.faker, b, f, g), e = e.slice(0, s.index) + s[1].repeat(a) + e.slice(s.index + s[0].length), s = o.exec(e);
        }
        let l = /(\d-\d|\w-\w|\d|\w|[-!@#$&()`.+,/"])/, c = /\[(\^|)(-|)(.+?)\](?:\{(\d+)(?:,(\d+)|)\}|(\?|\*|\+)|)/;
        for(s = c.exec(e); s != null;){
            let f = s[1] === "^", g = s[2] === "-", b = s[4], k = s[5], T = s[6], y = [], P = s[3], S = l.exec(P);
            for(g && y.push(45); S != null;){
                if (S[0].includes("-")) {
                    let A = S[0].split("-").map((d)=>d.codePointAt(0) ?? Number.NaN);
                    if (r = A[0], n = A[1], r > n) throw new m("Character range provided is out of order.");
                    for(let d = r; d <= n; d++)if (t && Number.isNaN(Number(String.fromCodePoint(d)))) {
                        let de = String.fromCodePoint(d);
                        y.push(de.toUpperCase().codePointAt(0) ?? Number.NaN, de.toLowerCase().codePointAt(0) ?? Number.NaN);
                    } else y.push(d);
                } else t && Number.isNaN(Number(S[0])) ? y.push(S[0].toUpperCase().codePointAt(0) ?? Number.NaN, S[0].toLowerCase().codePointAt(0) ?? Number.NaN) : y.push(S[0].codePointAt(0) ?? Number.NaN);
                P = P.substring(S[0].length), S = l.exec(P);
            }
            if (a = De(this.faker, T, b, k), f) {
                let A = -1;
                for(let d = 48; d <= 57; d++){
                    if (A = y.indexOf(d), A > -1) {
                        y.splice(A, 1);
                        continue;
                    }
                    y.push(d);
            ...
            let rt = this.multiple(()=>String.fromCodePoint(this.arrayElement(y)), {
                count: a
            }).join("");
            e = e.slice(0, s.index) + rt + e.slice(s.index + s[0].length), s = c.exec(e);
        }
        let u = /(.)\{(\d+),(\d+)\}/;
        for(s = u.exec(e); s != null;){
            if (r = Number.parseInt(s[2]), n = Number.parseInt(s[3]), r > n) throw new m("Numbers out of order in {} quantifier.");
            a = this.faker.number.int({
                min: r,
                max: n
            }), e = e.slice(0, s.index) + s[1].repeat(a) + e.slice(s.index + s[0].length), s = u.exec(e);
        }
        let h = /(.)\{(\d+)\}/;
        for(s = h.exec(e); s != null;)a = Number.parseInt(s[2]), e = e.slice(0, s.index) + s[1].repeat(a) + e.slice(s.index + s[0].length), s = h.exec(e);
        return e;
    }
    shuffle(e, t = {}) {
        let { inplace: r = !1 } = t;
    ...
    uniqueArray(e, t) {
        if (Array.isArray(e)) {
            ...
            return this.shuffle(a).splice(0, t);
        }
        let r = new Set;
        try {
            if (typeof e == "function") {
                let n = 1e3 * t, a = 0;
                for(; r.size < t && a < n;)r.add(e()), a++;
            }
        } catch  {}
        return [
            ...r
    ...
    mustache(e, t) {
        if (e == null) return "";
        for(let r in t){
            let n = new RegExp(`{{${r}}}`, "g"), a = t[r];
            typeof a == "string" && (a = a.replaceAll("$", "$$$$")), e = e.replace(n, a);
        }
        return e;
    }
    maybe(e, t = {}) {
    ...
    objectValue(e) {
        let t = this.faker.helpers.objectKey(e);
        return e[t];
    }
    objectEntry(e) {
        let t = this.faker.helpers.objectKey(e);
    ...
    arrayElement(e) {
        ...
        let t = e.length > 1 ? this.faker.number.int({
            max: e.length - 1
        }) : 0;
        return e[t];
    }
    weightedArrayElement(e) {
        ...
        if (!e.every((a)=>a.weight > 0)) throw new m("weightedArrayElement expects an array of { weight, value } objects where weight is a positive number");
        let t = e.reduce((a, { weight: o })=>a + o, 0), r = this.faker.number.float({
            min: 0,
            max: t
        }), n = 0;
        for (let { weight: a, value: o } of e)if (n += a, r < n) return o;
        return e.at(-1).value;
    }
    arrayElements(e, t) {
        if (e.length === 0) return [];
        let r = this.rangeToNumber(t ?? {
            min: 1,
            max: e.length
        });
        ...
        let n = [
            ...e
        ], a = e.length, o = a - r, s, l;
        for(; a-- > o;)l = this.faker.number.int(a), s = n[l], n[l] = n[a], n[a] = s;
        return n.slice(o);
    }
    enumValue(e) {
        let t = Object.keys(e).filter((n)=>Number.isNaN(Number(n))), r = this.arrayElement(t);
        return e[r];
    }
    rangeToNumber(e) {
    ...
    multiple(e, t = {}) {
        let r = this.rangeToNumber(t.count ?? 3);
    ...
    fake(t) {
        t = typeof t == "string" ? t : this.arrayElement(t);
        let r = t.search(/{{[a-z]/), n = t.indexOf("}}", r);
        if (r === -1 || n === -1) return t;
        let o = t.substring(r + 2, n + 2).replace("}}", "").replace("{{", ""), s = Ce(o, this.faker), l = String(s), c = t.substring(0, r) + l + t.substring(n + 2);
        return this.fake(c);
    }
};
var j = class extends x {
    int(e = {}) {
        ...
        let { min: t = 0, max: r = Number.MAX_SAFE_INTEGER, multipleOf: n = 1 } = e;
        if (!Number.isInteger(n)) throw new m("multipleOf should be an integer.");
        if (n <= 0) throw new m("multipleOf should be greater than 0.");
        let a = Math.ceil(t / n), o = Math.floor(r / n);
        if (a === o) return a * n;
        if (o < a) throw r >= t ? new m(`No suitable integer value between ${t} and ${r} found.`) : new m(`Max ${r} should be greater than min ${t}.`);
        let l = this.faker._randomizer.next(), c = o - a + 1;
        return Math.floor(l * c + a) * n;
    }
    float(e = {}) {
        typeof e == "number" && (e = {
            max: e
        });
        let { min: t = 0, max: r = 1, fractionDigits: n, multipleOf: a, multipleOf: o = n == null ? void 0 : 10 ** -n } = e;
        if (r === t) return t;
        if (r < t) throw new m(`Max ${r} should be greater than min ${t}.`);
        if (n != null) {
            if (a != null) throw new m("multipleOf and fractionDigits cannot be set at the same time.");
            if (!Number.isInteger(n)) throw new m("fractionDigits should be an integer.");
            if (n < 0) throw new m("fractionDigits should be greater than or equal to 0.");
        }
        if (o != null) {
        ...
        return this.faker._randomizer.next() * (r - t) + t;
    }
    binary(e = {}) {
        typeof e == "number" && (e = {
            max: e
        });
        let { min: t = 0, max: r = 1 } = e;
        return this.int({
            max: r,
            min: t
        }).toString(2);
    ...
    bigInt(e = {}) {
        ...
        let t = BigInt(e.min ?? 0), r = BigInt(e.max ?? t + BigInt(999999999999999));
        if (r === t) return t;
        if (r < t) throw new m(`Max ${r} should be larger then min ${t}.`);
        let n = r - t, a = BigInt(this.faker.string.numeric({
            length: n.toString(10).length,
            allowLeadingZeros: !0
        })) % (n + BigInt(1));
        return t + a;
    }
...
var H = [
    ...
    fromCharacters(e, t = 1) {
        if (t = this.faker.helpers.rangeToNumber(t), t <= 0) return "";
    ...
    alpha(e = {}) {
        ...
        let t = this.faker.helpers.rangeToNumber(e.length ?? 1);
        if (t <= 0) return "";
        ...
        return a = a.filter((o)=>!n.includes(o)), this.fromCharacters(a, t);
    }
    alphanumeric(e = {}) {
        typeof e == "number" && (e = {
            length: e
    ...
    hexadecimal(e = {}) {
        let { casing: t = "mixed", prefix: r = "0x" } = e, n = this.faker.helpers.rangeToNumber(e.length ?? 1);
        if (n <= 0) return r;
        let a = this.fromCharacters([
            "0",
            "1",
            "2",
            "3",
        ...
        return t === "upper" ? a = a.toUpperCase() : t === "lower" && (a = a.toLowerCase()), `${r}${a}`;
    }
    numeric(e = {}) {
        typeof e == "number" && (e = {
            length: e
        ...
        let a = Re.filter((s)=>!n.includes(s));
        if (a.length === 0 || a.length === 1 && !r && a[0] === "0") throw new m("Unable to generate numeric string, because all possible digits are excluded.");
        let o = "";
        return !r && !n.includes("0") && (o += this.faker.helpers.arrayElement(a.filter((s)=>s !== "0"))), o += this.fromCharacters(a, t - o.length), o;
    }
    sample(e = 10) {
        ...
        for(; r.length < e;)r += String.fromCodePoint(this.faker.number.int(t));
        return r;
    }
    uuid() {
    ...
    nanoid(e = 21) {
        ...
        for(; r.length < e;){
            let n = this.faker.helpers.weightedArrayElement(t);
            r += n();
        }
        return r;
    }
...
function B(i) {
    let e = `[@faker-js/faker]: ${i.deprecated} is deprecated`;
    i.since && (e += ` since v${i.since}`), i.until && (e += ` and will be removed in v${i.until}`), i.proposed && (e += `. Please use ${i.proposed} instead`), console.warn(`${e}.`);
}
...
var gt = {
    ...
    price(e = {}) {
        let { dec: t = 2, max: r = 1e3, min: n = 1, symbol: a = "" } = e;
        if (n < 0 || r < 0) return `${a}0`;
        if (n === r) return `${a}${n.toFixed(t)}`;
        let o = this.faker.number.float({
            min: n,
            max: r,
            fractionDigits: t
        });
        if (t === 0) return `${a}${o.toFixed(t)}`;
        let s = o * 10 ** t % 10, l = this.faker.helpers.weightedArrayElement([
            {
                weight: 5,
                value: 9
            },
        ...
        ]), c = (1 / 10) ** t, u = s * c, h = l * c, f = o - u + h;
        return n <= f && f <= r ? `${a}${f.toFixed(t)}` : `${a}${o.toFixed(t)}`;
    }
    productAdjective() {
    ...
    isbn(e = {}) {
        ...
        let { variant: t = 13, separator: r = "-" } = e, n = "978", [a, o] = this.faker.helpers.objectEntry(gt), s = this.faker.string.numeric(8), l = Number.parseInt(s.slice(0, -1)), c = o.find(([k])=>l <= k)?.[1];
        if (!c) throw new m(`Unable to find a registrant length for the group ${a}`);
        ...
        let g = f.join(""), b = 0;
        for(let k = 0; k < t - 1; k++){
            let T = t === 10 ? k + 1 : k % 2 ? 3 : 1;
            b += T * Number.parseInt(g[k]);
        }
        return b = t === 10 ? b % 11 : (10 - b % 10) % 10, f.push(b === 10 ? "X" : b.toString()), f.join(r);
    }
};
...
function kt(i) {
    let e = "";
    for(let t = 0; t < i.length; t += 4)e += `${i.substring(t, t + 4)} `;
    return e.trimEnd();
}
var X = class extends p {
    ...
    routingNumber() {
        ...
        for(let r = 0; r < e.length; r += 3)t += Number(e[r]) * 3, t += Number(e[r + 1]) * 7, t += Number(e[r + 2]) || 0;
        return `${e}${Math.ceil(t / 10) * 10 - t}`;
    }
    maskedNumber(e = {}) {
        typeof e == "number" && (e = {
            length: e
        });
        let { ellipsis: t = !0, length: r = 4, parens: n = !0 } = e, a = this.faker.string.numeric({
            length: r
        });
        return t && (a = `...${a}`), n && (a = `(${a})`), a;
    }
    amount(e = {}) {
        let { autoFormat: t = !1, dec: r = 2, max: n = 1e3, min: a = 0, symbol: o = "" } = e, s = this.faker.number.float({
            max: n,
            min: a,
            fractionDigits: r
        }), l = t ? s.toLocaleString(void 0, {
    ...
    bitcoinAddress(e = {}) {
        let { type: t = this.faker.helpers.enumValue(he), network: r = "mainnet" } = e, n = we[t], a = n.prefix[r], o = this.faker.number.int(n.length), s = this.faker.string.alphanumeric({
            length: o - a.length,
            casing: n.casing,
            exclude: n.exclude
        });
    ...
    creditCardNumber(e = {}) {
        ...
        let { issuer: t = "" } = e, r, n = this.faker.definitions.finance.credit_card, a = t.toLowerCase();
        if (a in n) r = this.faker.helpers.arrayElement(n[a]);
        else if (t.includes("#")) r = t;
        else {
    ...
    pin(e = {}) {
        ...
        let { length: t = 4 } = e;
        if (t < 1) throw new m("minimum length is 1");
        return this.faker.string.numeric({
            length: t,
            allowLeadingZeros: !0
        });
    ...
    iban(e = {}) {
        let { countryCode: t, formatted: r = !1 } = e, n = t ? E.formats.find((c)=>c.country === t) : this.faker.helpers.arrayElement(E.formats);
        if (!n) throw new m(`Country code ${t} not supported.`);
        let a = "", o = 0;
        for (let c of n.bban){
            let u = c.count;
            for(o += c.count; u > 0;)c.type === "a" ? a += this.faker.helpers.arrayElement(E.alpha) : c.type === "c" ? this.faker.datatype.boolean(.8) ? a += this.faker.number.int(9) : a += this.faker.helpers.arrayElement(E.alpha) : u >= 3 && this.faker.datatype.boolean(.3) ? this.faker.datatype.boolean() ? (a += this.faker.helpers.arrayElement(E.pattern100), u -= 2) : (a += this.faker.helpers.arrayElement(E.pattern10), u--) : a += this.faker.number.int(9), u--;
            a = a.substring(0, o);
        }
        let s = 98 - E.mod97(E.toDigitString(`${a}${n.country}00`));
        s < 10 && (s = `0${s}`);
        let l = `${n.country}${s}${a}`;
        return r ? kt(l) : l;
    }
    bic(e = {}) {
        let { includeBranchCode: t = this.faker.datatype.boolean() } = e, r = this.faker.string.alpha({
            length: 4,
            casing: "upper"
        }), n = this.faker.helpers.arrayElement(E.iso3166), a = this.faker.string.alphanumeric({
            length: 2,
            casing: "upper"
        }), o = t ? this.faker.datatype.boolean() ? this.faker.string.alphanumeric({
            length: 3,
            casing: "upper"
        }) : "XXX" : "";
        return `${r}${n}${a}${o}`;
    ...
    transactionDescription() {
        let e = this.amount(), t = this.faker.company.name(), r = this.transactionType(), n = this.accountNumber(), a = this.maskedNumber(), o = this.currencyCode();
        return `${r} transaction at ${t} using card ending with ***${a} for ${o} ${e} in account ***${n}`;
    }
};
var Q = class extends p {
    ...
    dish() {
        let e = (t)=>t.split(" ").map((r)=>r.charAt(0).toUpperCase() + r.slice(1)).join(" ");
...
var xt = "\xA0", q = class extends p {
    branch() {
        let e = this.faker.hacker.noun().replace(" ", "-"), t = this.faker.hacker.verb().replace(" ", "-");
        return `${e}-${t}`;
    }
    commitEntry(e = {}) {
        let { merge: t = this.faker.datatype.boolean({
            probability: .2
        }), eol: r = "CRLF", refDate: n } = e, a = [
            `commit ${this.faker.git.commitSha()}`
        ];
        t && a.push(`Merge: ${this.commitSha({
            length: 7
        })} ${this.commitSha({
            length: 7
        })}`);
        ...
        u = u.replaceAll(/^[.,:;"\\']|[<>\n]|[.,:;"\\']$/g, ""), a.push(`Author: ${u} <${h}>`, `Date: ${this.commitDate({
            refDate: n
        })}`, "", `${xt.repeat(4)}${this.commitMessage()}`, "");
        let f = r === "CRLF" ? `\r
` : `
`;
        return a.join(f);
    ...
    commitDate(e = {}) {
        let { refDate: t = this.faker.defaultRefDate() } = e, r = [
            "Sun",
            "Mon",
            "Tue",
            "Wed",
            ...
            "Nov",
            "Dec"
        ], a = this.faker.date.recent({
            days: 1,
            refDate: t
        }), o = r[a.getUTCDay()], s = n[a.getUTCMonth()], l = a.getUTCDate(), c = a.getUTCHours().toString().padStart(2, "0"), u = a.getUTCMinutes().toString().padStart(2, "0"), h = a.getUTCSeconds().toString().padStart(2, "0"), f = a.getUTCFullYear(), g = this.faker.number.int({
            min: -11,
            max: 12
        }), b = Math.abs(g).toString().padStart(2, "0"), k = "00", T = g >= 0 ? "+" : "-";
        return `${o} ${s} ${l} ${c}:${u}:${h} ${f} ${T}${b}${k}`;
    }
    commitSha(e = {}) {
        let { length: t = 40 } = e;
        return this.faker.string.hexadecimal({
...
var ee = class extends p {
    ...
    phrase() {
        let e = {
            ...
            noun: this.noun,
            verb: this.verb
        }, t = this.faker.helpers.arrayElement(this.faker.definitions.hacker.phrase);
        return this.faker.helpers.mustache(t, e);
    }
};
var $e = typeof Buffer > "u" ? (i)=>{
    let e = new TextEncoder().encode(i), t = Array.from(e, (r)=>String.fromCodePoint(r)).join("");
    return btoa(t);
...
var te = class extends p {
    ...
    url(e = {}) {
        let { width: t = this.faker.number.int({
            min: 1,
            max: 3999
        ...
        return this.faker.helpers.arrayElement([
            this.urlLoremFlickr,
            ({ width: a, height: o })=>this.urlPicsumPhotos({
                    width: a,
                    height: o,
                    grayscale: !1,
                    blur: 0
    ...
    urlLoremFlickr(e = {}) {
        ...
        return `https://loremflickr.com/${t}/${r}${n == null ? "" : `/${n}`}?lock=${this.faker.number.int()}`;
    }
    urlPicsumPhotos(e = {}) {
        let { width: t = this.faker.number.int({
            min: 1,
            ...
            min: 1,
            max: 3999
        }), grayscale: n = this.faker.datatype.boolean(), blur: a = this.faker.number.int({
            max: 10
        ...
        })}/${t}/${r}`, s = typeof a == "number" && a >= 1 && a <= 10;
        return (n || s) && (o += "?", n && (o += "grayscale"), n && s && (o += "&"), s && (o += `blur=${a}`)), o;
    }
    urlPlaceholder(e = {}) {
        let { width: t = this.faker.number.int({
            min: 1,
            ...
            format: "hex",
            prefix: ""
        }), textColor: a = this.faker.color.rgb({
            format: "hex",
            prefix: ""
        ...
        return l += `/${t}`, l += `x${r}`, l += `/${n}`, l += `/${a}`, l += `.${o}`, l += `?text=${encodeURIComponent(s)}`, l;
    }
    dataUri(e = {}) {
        let { width: t = this.faker.number.int({
            min: 1,
            ...
            min: 1,
            max: 3999
        }), color: n = this.faker.color.rgb(), type: a = this.faker.helpers.arrayElements([
            "svg-uri",
            "svg-base64"
        ]) } = e, o = `<svg xmlns="http://www.w3.org/2000/svg" version="1.1" baseProfile="full" width="${t}" height="${r}"><rect width="100%" height="100%" fill="${n}"/><text x="${t / 2}" y="${r / 2}" font-size="20" alignment-baseline="middle" text-anchor="middle" fill="white">${t}x${r}</text></svg>`;
        return a === "svg-uri" ? `data:image/svg+xml;charset=UTF-8,${encodeURIComponent(o)}` : `data:image/svg+xml;base64,${$e(o)}`;
    }
};
var At = Object.fromEntries([
    [
        "\u0410",
        "A"
    ],
...
function Be(i) {
    let e = ()=>i.helpers.arrayElement([
        ...
        }, u = i.helpers.objectKey(c), h = i.helpers.arrayElement(c[u]);
        return [
            u,
            h
        ];
    }, r = (c)=>i.helpers.arrayElement({
            lin: [
                "i686",
                "x86_64"
            ],
        ...
        let u = "";
        for(let h = 0; h < c; h++)u += `.${i.string.numeric({
            allowLeadingZeros: !0
        })}`;
        return u;
    }, a = {
        ...
        firefox (c) {
            let u = `${i.number.int({
                min: 5,
                max: 15
            })}${n(2)}`, h = `Gecko/20100101 Firefox/${u}`, f = r(c);
            return `Mozilla/5.0 ${c === "win" ? `(Windows NT ${a.nt()}${f ? `; ${f}` : ""}` : c === "mac" ? `(Macintosh; ${f} Mac OS X ${a.osx()}` : `(X11; Linux ${f}`}; rv:${u.slice(0, -2)}) ${h}`;
        },
        iexplorer () {
            let c = a.ie();
            return c >= 11 ? `Mozilla/5.0 (Windows NT 6.${i.number.int({
                min: 1,
                max: 3
            })}; Trident/7.0; ${i.datatype.boolean() ? "Touch; " : ""}rv:11.0) like Gecko` : `Mozilla/5.0 (compatible; MSIE ${c}.0; Windows NT ${a.nt()}; Trident/${a.trident()}${i.datatype.boolean() ? `; .NET CLR ${a.net()}` : ""})`;
        },
        opera (c) {
            let u = ` Presto/${a.presto()} Version/${a.presto2()})`, h = c === "win" ? `(Windows NT ${a.nt()}; U; ${e()}${u}` : c === "lin" ? `(X11; Linux ${r(c)}; U; ${e()}${u}` : `(Macintosh; Intel Mac OS X ${a.osx()} U; ${e()} Presto/${a.presto()} Version/${a.presto2()})`;
            return `Opera/${i.number.int({
                min: 9,
                max: 14
            })}.${i.number.int(99)} ${h}`;
        },
        safari (c) {
            let u = a.safari(), h = `${i.number.int({
                min: 4,
                max: 7
            })}.${i.number.int(1)}.${i.number.int(10)}`;
            return `Mozilla/5.0 ${c === "mac" ? `(Macintosh; ${r("mac")} Mac OS X ${a.osx("_")} rv:${i.number.int({
                min: 2,
                max: 6
            })}.0; ${e()}) ` : `(Windows; U; Windows NT ${a.nt()})`}AppleWebKit/${u} (KHTML, like Gecko) Version/${h} Safari/${u}`;
        },
        chrome (c) {
            let u = a.safari();
            return `Mozilla/5.0 ${c === "mac" ? `(Macintosh; ${r("mac")} Mac OS X ${a.osx("_")}) ` : c === "win" ? `(Windows; U; Windows NT ${a.nt()})` : `(X11; Linux ${r(c)}`} AppleWebKit/${u} (KHTML, like Gecko) Chrome/${a.chrome()} Safari/${u}`;
        }
    }, [s, l] = t();
    return o[s](l);
}
var re = class extends p {
    email(e = {}) {
        let { firstName: t, lastName: r, provider: n = this.faker.helpers.arrayElement(this.faker.definitions.internet.free_email), allowSpecialCharacters: a = !1 } = e, o = this.userName({
            firstName: t,
            lastName: r
        });
        if (o = o.replaceAll(/[^A-Za-z0-9._+-]+/g, ""), o = o.substring(0, 50), a) {
            let s = [
                ..."._-"
            ], l = [
                ...".!#$%&'*+-/=?^_`{|}~"
    ...
    exampleEmail(e = {}) {
        let { firstName: t, lastName: r, allowSpecialCharacters: n = !1 } = e, a = this.faker.helpers.arrayElement(this.faker.definitions.internet.example_email);
        return this.email({
            firstName: t,
            lastName: r,
            provider: a,
    ...
    userName(e = {}) {
        let { firstName: t = this.faker.person.firstName(), lastName: r = this.faker.person.lastName(), lastName: n } = e, a = this.faker.helpers.arrayElement([
            ".",
            "_"
    ...
    displayName(e = {}) {
        let { firstName: t = this.faker.person.firstName(), lastName: r = this.faker.person.lastName() } = e, n = this.faker.helpers.arrayElement([
            ".",
            "_"
        ]), a = this.faker.number.int(99), o = [
            ()=>`${t}${a}`,
            ()=>`${t}${n}${r}`,
            ()=>`${t}${n}${r}${a}`
    ...
    httpStatusCode(e = {}) {
        let { types: t = Object.keys(this.faker.definitions.internet.http_status_code) } = e, r = this.faker.helpers.arrayElement(t);
        return this.faker.helpers.arrayElement(this.faker.definitions.internet.http_status_code[r]);
    }
    url(e = {}) {
        let { appendSlash: t = this.faker.datatype.boolean(), protocol: r = "https" } = e;
        return `${r}://${this.domainName()}${t ? "/" : ""}`;
    }
    domainName() {
    ...
    ipv4() {
        return Array.from({
            length: 4
        }, ()=>this.faker.number.int(255)).join(".");
    }
    ipv6() {
        return Array.from({
            length: 8
    ...
    userAgent() {
        return Be(this.faker);
    }
    color(e = {}) {
        let { redBase: t = 0, greenBase: r = 0, blueBase: n = 0 } = e, a = (c)=>Math.floor((this.faker.number.int(256) + c) / 2).toString(16).padStart(2, "0"), o = a(t), s = a(r), l = a(n);
        return `#${o}${s}${l}`;
    }
    mac(e = {}) {
        typeof e == "string" && (e = {
        ...
        let { separator: t = ":" } = e, r, n = "";
        for([
            ":",
            "-",
            ""
        ].includes(t) || (t = ":"), r = 0; r < 12; r++)n += this.faker.number.hex(15), r % 2 === 1 && r !== 11 && (n += t);
        return n;
    }
    password(e = {}) {
        let t = /[aeiouAEIOU]$/, r = /[bcdfghjklmnpqrstvwxyzBCDFGHJKLMNPQRSTVWXYZ]$/, n = (c, u, h, f)=>{
            if (f.length >= c) return f;
            u && (h = r.test(f) ? t : r);
            let g = this.faker.number.int(94) + 33, b = String.fromCodePoint(g);
            return u && (b = b.toLowerCase()), h.test(b) ? n(c, u, h, f + b) : n(c, u, h, f);
        }, { length: a = 15, memorable: o = !1, pattern: s = /\w/, prefix: l = "" } = e;
        return n(a, o, s, l);
    }
    emoji(e = {}) {
        let { types: t = Object.keys(this.faker.definitions.internet.emoji) } = e, r = this.faker.helpers.arrayElement(t);
...
var ne = class extends p {
    ...
    streetAddress(e = {}) {
        ...
        let { useFullAddress: t } = e, n = this.faker.definitions.location.street_address[t ? "full" : "normal"];
        return this.faker.helpers.fake(n);
    }
    secondaryAddress() {
    ...
    state(e = {}) {
        let { abbreviated: t = !1 } = e, r = t ? this.faker.definitions.location.state_abbr : this.faker.definitions.location.state;
        return this.faker.helpers.arrayElement(r);
    }
    latitude(e = {}) {
        let { max: t = 90, min: r = -90, precision: n = 4 } = e;
    ...
    longitude(e = {}) {
        let { max: t = 180, min: r = -180, precision: n = 4 } = e;
        return this.faker.number.float({
            max: t,
            min: r,
            fractionDigits: n
    ...
    nearbyGPSCoordinate(e = {}) {
        let { origin: t, radius: r = 10, isMetric: n = !1 } = e;
        if (t == null) return [
            this.latitude(),
            this.longitude()
        ];
        let a = this.faker.number.float({
            max: 2 * Math.PI,
            fractionDigits: 5
        }), o = n ? r : r * 1.60934, l = this.faker.number.float({
            max: o,
            fractionDigits: 3
...
function Pe(i, e, t = (r)=>r) {
    let r = {};
    for (let n of i){
        let a = e(n);
        r[a] === void 0 && (r[a] = []), r[a].push(t(n));
    }
    return r;
}
var be = {
    ...
    closest: (i, e)=>{
        let t = Pe(i, (s)=>s.length), r = Object.keys(t).map(Number), n = Math.min(...r), a = Math.max(...r), o = Math.min(e.min - n, a - e.max);
        return i.filter((s)=>s.length === e.min - o || s.length === e.max + o);
    },
    shortest: (i)=>{
        let e = Math.min(...i.map((t)=>t.length));
        return i.filter((t)=>t.length === e);
    },
    longest: (i)=>{
        let e = Math.max(...i.map((t)=>t.length));
        return i.filter((t)=>t.length === e);
    },
    "any-length": (i)=>[
            ...i
...
function w(i) {
    let { wordList: e, length: t, strategy: r = "any-length" } = i;
    if (t) {
        let n = typeof t == "number" ? (o)=>o.length === t : (o)=>o.length >= t.min && o.length <= t.max, a = e.filter(n);
        return a.length > 0 ? a : typeof t == "number" ? be[r](e, {
            min: t,
            max: t
        }) : be[r](e, t);
    } else if (r === "shortest" || r === "longest") return be[r](e);
    return [
        ...e
    ];
}
var ae = class extends p {
    word(e = {}) {
        ...
        return this.faker.helpers.arrayElement(w({
            ...t,
    ...
    slug(e = 3) {
        let t = this.words(e);
        return this.faker.helpers.slugify(t);
    }
    sentences(e = {
        min: 2,
        max: 6
...
var oe = class extends p {
    number(e = {}) {
        let { style: t = "human" } = e, n = this.faker.definitions.phone_number.format[t];
        if (!n) throw new Error(`No definitions for ${t} in this locale`);
        let a = this.faker.helpers.arrayElement(n);
        return pe(this.faker, a);
    }
    imei() {
...
var Nt = [
    ...
    fileName(e = {}) {
        let { extensionCount: t = 1 } = e, r = this.faker.word.words().toLowerCase().replaceAll(/\W/g, "_"), n = this.faker.helpers.multiple(()=>this.fileExt(), {
            count: t
        }).join(".");
    ...
    fileType() {
        let e = this.faker.definitions.system.mime_type, t = new Set(Object.keys(e).map((r)=>r.split("/")[0]));
        return this.faker.helpers.arrayElement([
            ...t
        ]);
    }
    fileExt(e) {
        let t = this.faker.definitions.system.mime_type;
        if (typeof e == "string") return this.faker.helpers.arrayElement(t[e].extensions);
        let r = new Set(Object.values(t).flatMap(({ extensions: n })=>n));
        return this.faker.helpers.arrayElement([
            ...r
        ]);
    }
    ...
    networkInterface(e = {}) {
        let { interfaceType: t = this.faker.helpers.arrayElement(Rt), interfaceSchema: r = this.faker.helpers.objectKey(ve) } = e, n, a = "", o = ()=>this.faker.string.numeric({
                allowLeadingZeros: !0
            });
        switch(r){
            case "index":
            ...
            case "slot":
                {
                    n = `${o()}${this.faker.helpers.maybe(()=>`f${o()}`) ?? ""}${this.faker.helpers.maybe(()=>`d${o()}`) ?? ""}`;
                    break;
                }
            case "mac":
                {
            ...
            case "pci":
                {
                    a = this.faker.helpers.maybe(()=>`P${o()}`) ?? "", n = `${o()}s${o()}${this.faker.helpers.maybe(()=>`f${o()}`) ?? ""}${this.faker.helpers.maybe(()=>`d${o()}`) ?? ""}`;
                    break;
                }
        }
        return `${a}${t}${ve[r]}${n}`;
    ...
    cron(e = {}) {
        let { includeYear: t = !1, includeNonStandard: r = !1 } = e, n = [
            ...
            this.faker.helpers.arrayElement(Lt),
            "*",
            "?"
        ], c = [
            this.faker.number.int({
            ...
            "*"
        ], u = this.faker.helpers.arrayElement(n), h = this.faker.helpers.arrayElement(a), f = this.faker.helpers.arrayElement(o), g = this.faker.helpers.arrayElement(s), b = this.faker.helpers.arrayElement(l), k = this.faker.helpers.arrayElement(c), T = `${u} ${h} ${f} ${g} ${b}`;
        t && (T += ` ${k}`);
        let y = [
            "@annually",
            "@daily",
        ...
        return !r || this.faker.datatype.boolean() ? T : this.faker.helpers.arrayElement(y);
    }
};
...
var me = class extends p {
    ...
    sample(e = {}) {
        let t = this.faker.helpers.shuffle([
            this.adjective,
            this.adverb,
            this.conjunction,
            this.interjection,
...
var Ie = class extends $ {
    ...
    helpers = new U(this);
    image = new te(this);
    internet = new re(this);
    location = new ne(this);
    lorem = new ae(this);
    music = new ie(this);
    person = new _(this);
    phone = new oe(this);
    ...
    constructor(e){
        ...
        let { locale: t } = e;
        if (Array.isArray(t)) {
            if (t.length === 0) throw new m("The locale option must contain at least one locale definition.");
            t = Le(t);
        }
        this.rawDefinitions = t, this.definitions = Me(this.rawDefinitions);
    }
    getMetadata() {
...
"[project]/node_modules/@faker-js/faker/dist/chunk-IJTMZAVK.js [app-rsc] (ecmascript)": (({ r: __turbopack_require__, f: __turbopack_module_context__, i: __turbopack_import__, s: __turbopack_esm__, v: __turbopack_export_value__, n: __turbopack_export_namespace__, c: __turbopack_cache__, M: __turbopack_modules__, l: __turbopack_load__, j: __turbopack_dynamic__, P: __turbopack_resolve_absolute_path__, U: __turbopack_relative_url__, R: __turbopack_resolve_module_id_path__, g: global, __dirname, x: __turbopack_external_require__, y: __turbopack_external_import__ }) => (() => {
"use strict";

__turbopack_esm__({
    "a": ()=>f
});
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$faker$2d$js$2f$faker$2f$dist$2f$chunk$2d$I7VC7S6W$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/node_modules/@faker-js/faker/dist/chunk-I7VC7S6W.js [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$faker$2d$js$2f$faker$2f$dist$2f$chunk$2d$4ULBYILW$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/node_modules/@faker-js/faker/dist/chunk-4ULBYILW.js [app-rsc] (ecmascript)");
"__TURBOPACK__ecmascript__hoisting__location__";
;
;
var f = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$faker$2d$js$2f$faker$2f$dist$2f$chunk$2d$4ULBYILW$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["m"]({
    locale: [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$faker$2d$js$2f$faker$2f$dist$2f$chunk$2d$I7VC7S6W$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["a"],
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$faker$2d$js$2f$faker$2f$dist$2f$chunk$2d$4ULBYILW$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["n"]
    ]
});
;

})()),
"[project]/node_modules/@faker-js/faker/dist/chunk-IJTMZAVK.js [app-rsc] (ecmascript) <export a as faker>": (({ r: __turbopack_require__, f: __turbopack_module_context__, i: __turbopack_import__, s: __turbopack_esm__, v: __turbopack_export_value__, n: __turbopack_export_namespace__, c: __turbopack_cache__, M: __turbopack_modules__, l: __turbopack_load__, j: __turbopack_dynamic__, P: __turbopack_resolve_absolute_path__, U: __turbopack_relative_url__, R: __turbopack_resolve_module_id_path__, g: global, __dirname, x: __turbopack_external_require__, y: __turbopack_external_import__ }) => (() => {
"use strict";

__turbopack_esm__({
    "faker": ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$faker$2d$js$2f$faker$2f$dist$2f$chunk$2d$IJTMZAVK$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["a"]
});
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$faker$2d$js$2f$faker$2f$dist$2f$chunk$2d$IJTMZAVK$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/node_modules/@faker-js/faker/dist/chunk-IJTMZAVK.js [app-rsc] (ecmascript)");
"__TURBOPACK__ecmascript__hoisting__location__";
...
//# sourceMappingURL=node_modules_%40faker-js_faker_dist_3c40ca._.js.map